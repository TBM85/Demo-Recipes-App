...
export class RecipeService {
  ...
  private recipes: Recipe[] = [
    new Recipe(
      ...
      [
        new Ingredient('Cream cheese', 2, 'packs'),
        new Ingredient('Biscuits', 400, 'grams'),
        new Ingredient('Strawberries', 1, 'pound'),
        new Ingredient('Icing sugar', 20, 'grams'),
        new Ingredient('Butter', 150, 'grams'),
        new Ingredient('Vanilla pod', 1, 'unit')
      ]
    ),
    new Recipe(
      'Tomato Soup',
      ...
      [
        new Ingredient('Tomatoes', 6, 'units'),
        new Ingredient('Chicken broth', 1, 'liter'),
        new Ingredient('Onion', 1, 'unit'),
        new Ingredient('Garlic', 3, 'units'),
        new Ingredient('Basil leaves', 5, 'grams'),
        new Ingredient('Thyme', 1, 'gram')
      ]
    ),
    new Recipe(
      ...
      [
        new Ingredient('Beef', 2, 'kilograms'),
        new Ingredient('Mushrooms', 20, 'units'),
        new Ingredient('Peppers', 1, 'unit'),
        new Ingredient('Carrots', 2, 'units'),
        new Ingredient('Lettuce', 1, 'unit'),
        new Ingredient('Soy Sauce', 10, 'milliters')
      ]
    ),
    new Recipe(
      'Chicken Burger',
      ...
      [
        new Ingredient('Chicken', 1, 'kilogram'),
        new Ingredient('Brioche buns', 4, 'units'),
        new Ingredient('Cherry tomato', 500, 'grams'),
        new Ingredient('Red onion', 1, 'unit'),
        new Ingredient('Paprika', 10, 'grams'),
        new Ingredient('Black pepper', 1, 'gram'),
        new Ingredient('Basil leaves', 2, 'grams')
      ]
    )
  ];
